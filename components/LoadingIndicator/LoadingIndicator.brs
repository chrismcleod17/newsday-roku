...
sub init()
  ...
  m.textcolor = m.top.findNode("textColor")
...
sub updateLayout()
  ...
  m.backgroundImage.uri = m.top.backgroundUri
  m.backgroundImage.width = componentWidth
  m.backgroundImage.height = componentHeight
...
'  end if
  ...
  m.image.translation = [((loadingGroupWidth - m.image.width) / 2) - 350, -100]
  m.text.translation = [-20, m.image.height + m.top.spacing + 100]
  m.textcolor = "#ffffff"
